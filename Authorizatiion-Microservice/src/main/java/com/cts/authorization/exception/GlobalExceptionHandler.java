...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers,
		...
		ExceptionDetails exceptionDetails = new ExceptionDetails(ex.getMessage(), status.value(), LocalDateTime.now());
	...
	public ResponseEntity<Object> handleGlobalException(AuthorizationException ex, WebRequest request) {
		ExceptionDetails exceptionDetail = new ExceptionDetails(ex.getMessage(), HttpStatus.UNAUTHORIZED.value(),
				LocalDateTime.now());
		log.error(ex.getMessage());
